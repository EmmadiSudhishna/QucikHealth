...
import pharm from './Images/pharm.png'; // Import your admin image here
import axios from 'axios';

export default function PharmacyLogin({ setLoginState }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200 && response.data) {
        sessionStorage.setItem('pharmacyId', response.data.pharmacyId);
        setLoginState("Pharmacy");
        Navigate('/pharmacy/pharmacyhome'); // Navigate to admin home page
          ...
          <div className="">
            <div className="row">
              ...
              <div className="col-md-6">
                <img src={pharm} className="card-img" alt="Doctor" />
              </div>
              {/* Right side for login fields */}
              <div className="col-md-6">
                <div className="card-body"><br/><br/><br/>
                  <h4 className="card-title"><strong>Pharmacy Login</strong></h4><br/>
